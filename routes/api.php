...
Route::middleware('auth:api')->post('/company/add','Api\CompanyController@add');
Route::middleware('auth:api')->put('/company/update/{id}','Api\CompanyController@update');
Route::middleware('auth:api')->get('/company/info/{id}','Api\CompanyController@get');

Route::middleware('auth:api')->get('/manufacturer/list','Api\ManufacturerController@list');
Route::middleware('auth:api')->post('/manufacturer/add','Api\ManufacturerController@add');
